...
if (figma.editorType === "figma") {
    function createCoverThumbnail(coverPage) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!projectNameText) {
                ...
                yield applyText(projectNameText, "Project Name", "Roboto", "Testing Name", 200, "Bold", { value: -2, unit: "PERCENT" }, "#000000");
    ...
    function getSecondV0DatePage() {
        const matches = figma.root.children
            .filter(n => n.type === "PAGE" && n.name === "  V0 - [Date]");
    ...
    figma.on("run", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const orderedNodes = STRUCTURE.map((item) => {
            if (item.type === "page") {
                ...
                if (!d) {
                    d = figma.createPageDivider(); // if typings are updated, just: figma.createPageDivider()
        ...
        figma.notify(`Structure applied. Added ${created} extra "${EXTRA_PAGE_NAME}" page(s). Total: ${figma.root.children.length}.`);
        figma.closePlugin();
    }));
}
